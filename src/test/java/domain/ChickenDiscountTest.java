...
public class ChickenDiscountTest {
    ...
    void discount() {
        ...
        assertThat(chicken.discount(order2)).isEqualTo(order2.getMenu().getPrice() * order2.getQuantity().getValue() - 10000);
        assertThat(chicken.discount(order3)).isEqualTo(order3.getMenu().getPrice() * order3.getQuantity().getValue() - 20000);
    }
}
